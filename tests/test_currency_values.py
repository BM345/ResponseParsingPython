...
class TestCurrencyValueValidation(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        ["12.000", merge(constraints.dollars, constraints.removeTrailingZerosFromNormalizedForm), False, "12.000"],
        ...
        ["12.000", merge(constraints.pounds, constraints.removeTrailingZerosFromNormalizedForm), False, "12.000"],
        ...
        ["12.0", constraints.egp, False, "12.0"],
        ["12.00", constraints.egp, True, "12.00"],
        ["12.000", constraints.egp, False, "12.000"],
        ["12.000", merge(constraints.egp, constraints.removeTrailingZerosFromNormalizedForm), False, "12.000"],
        ...
        ["12.0", constraints.sar, False, "12.0"],
        ["12.00", constraints.sar, True, "12.00"],
        ["12.000", constraints.sar, False, "12.000"],
        ["12.000", merge(constraints.sar, constraints.removeTrailingZerosFromNormalizedForm), False, "12.000"],
